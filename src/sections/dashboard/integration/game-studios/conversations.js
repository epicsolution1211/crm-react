...
const dummyConversations = [
  {
    ...
    providerLogo: "/assets/providers/evo-play.png",
    ...
    messages: [
      {
        ...
        senderId: "evo_play",
        senderName: "EVOPLAY",
        senderAvatar: "/assets/providers/evo-play.png",
  ...
  {
    id: 3,
    providerId: "booming_games",
    providerName: "Booming Games",
    providerLogo: "/assets/providers/booming-games.jpg",
    lastMessage: "Please find the integration documentation attached.",
    lastMessageTime: new Date("2025-09-30T18:45:00"),
    unread: false,
    active: false,
    messages: []
  },
  {
    id: 4,
    providerId: "peter_and_sons",
    providerName: "Peter & Sons",
    providerLogo: "/assets/providers/peter-and-sons.png",
    lastMessage: "Looking forward to working with you.",
    lastMessageTime: new Date("2025-11-05T09:33:00"),
    unread: false,
    active: false,
    messages: []
  }
...
export const Conversations = () => {
  ...
  const handleViewProfile = () => {
    if (selectedConversation?.providerId) {
      router.push(`/dashboard/integration/game-studios/${selectedConversation.providerId}`);
    }
  };
