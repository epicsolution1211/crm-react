export const paths = {
  ...
  home: {
    ...
    customers: '/customers',
    agents: '/agents',
    agentsReport: '/agents/report/:agentId',
  ...
  dashboard: {
    ...
    agentsReport: "/dashboard/agents/report/:agentId",
    log: "/dashboard/logs",
    risk: {
      ...
      history: '/dashboard/risk-management/history/:target/:id',
    },
    complianceAudit: {
    ...
    integration: {
      ...
      availableGameProvider: "/dashboard/integration/available-game-provider",
      gameStudioDetail: "/dashboard/integration/game-studios/:providerType",
      paymentSystemDetail: "/dashboard/integration/payment-system/:providerType",
    },
    paymentAudit: {
