...
export const contacts = [
  ...
  },
  {
    ...
    avatar: getAssetPath('/assets/avatars/avatar-fran-perez.png'),
    isActive: true,
    lastActivity: now.getTime(),
    name: 'Fran Perez'
  },
  {
    ...
    avatar: getAssetPath('/assets/avatars/avatar-jie-yan-song.png'),
    isActive: true,
    lastActivity: now.getTime(),
    name: 'Jie Yan Song'
  },
  ...
  },
  {
    ...
    avatar: getAssetPath('/assets/avatars/avatar-penjani-inyene.png'),
    isActive: false,
  ...
  },
  {
    ...
    avatar: getAssetPath('/assets/avatars/avatar-omar-darboe.png'),
    isActive: true,
    lastActivity: now.getTime(),
    name: 'Omar Darobe'
  },
  {
    ...
    avatar: getAssetPath('/assets/avatars/avatar-siegbert-gottfried.png'),
    isActive: true,
    lastActivity: now.getTime(),
  ...
  },
  {
    ...
    avatar: getAssetPath('/assets/avatars/avatar-iulia-albu.png'),
    isActive: true,
    lastActivity: now.getTime(),
    name: 'Iulia Albu'
  },
  {
    ...
    avatar: getAssetPath('/assets/avatars/avatar-nasimiyu-danai.png'),
    isActive: true,
    lastActivity: now.getTime(),
    name: 'Nasimiyu Danai'
  }
...
export const threads = [
  {
    ...
    messages: [
      ...
      },
      {
        ...
        attachments: [],
        body: getAssetPath('/assets/covers/minimal-1-4x3-small.png'),
        contentType: 'image',
